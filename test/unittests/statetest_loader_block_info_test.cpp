...
TEST(statetest_loader, block_info)
{
    constexpr std::string_view input = R"({
            "currentCoinbase": "Q1111111111111111111111111111111111111111",
            "currentGasLimit": "0x0",
            "currentNumber": "0",
            "currentTimestamp": "0",
            "currentBaseFee": "7",
    ...
    EXPECT_EQ(bi.coinbase, "Q1111111111111111111111111111111111111111"_address);
...
{
    constexpr std::string_view input = R"({
        "currentCoinbase": "Q2adc25665018aa1fe0e6bc666dac8fc2697ff9ba",
    ...
    const auto bi = test::from_json<state::BlockInfo>(json::json::parse(input));
    EXPECT_EQ(bi.coinbase, "Q2adc25665018aa1fe0e6bc666dac8fc2697ff9ba"_address);
    EXPECT_EQ(bi.prev_randao, 0x00_bytes32);
...
TEST(statetest_loader, block_info_withdrawals)
{
            ...
            "withdrawals": [
                {
                    "index": "0x0",
                    "validatorIndex": "0x0",
                    "address": "Q0000000000000000000000000000000000000100",
                    "amount": "0x800000000"
                },
                {
                    "index": "0x1",
                    "validatorIndex": "0x1",
                    "address": "Q0000000000000000000000000000000000000200",
    ...
    EXPECT_EQ(bi.withdrawals[0].recipient, "Q0000000000000000000000000000000000000100"_address);
    EXPECT_EQ(bi.withdrawals[0].get_amount(), intx::uint256{0x800000000} * 1'000'000'000);
    EXPECT_EQ(bi.withdrawals[1].recipient, "Q0000000000000000000000000000000000000200"_address);
